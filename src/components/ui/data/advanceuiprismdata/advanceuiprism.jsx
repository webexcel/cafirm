...
export const accordian1 = `<Accordion.Item eventKey="0">
...
export const accordian2 = `<Accordion defaultActiveKey={['0']} alwaysOpen>
...
export const accordian3 = `<Accordion defaultActiveKey="0" className="accordion accordion-solid-primary">
<Accordion.Item eventKey="0">
  <Accordion.Header>Accordion Item #1</Accordion.Header>
    <Accordion.Body> <strong>This is the first item's accordion body.</strong> It is shown by
     default, until the collapse plugin adds the appropriate classes that we
...
export const accordian4 = `<Accordion defaultActiveKey="0" className="accordion accordion-solid-secondary">
<Accordion.Item eventKey="0">
  <Accordion.Header>Accordion Item #1</Accordion.Header>
  <Accordion.Body> <strong>This is the first item's accordion body.</strong> It is shown by
     default, until the collapse plugin adds the appropriate classes that we
...
export const accordian5 = `<Accordion defaultActiveKey="0" className="accordion accordion-primary">
<Accordion.Item eventKey="0">
  <Accordion.Header>Accordion Item #1</Accordion.Header>
  <Accordion.Body> <strong>This is the first item's accordion body.</strong> It is shown by
     default, until the collapse plugin adds the appropriate classes that we
...
export const accordian6 = `<Accordion defaultActiveKey="0" className="accordion accordion-secondary">
<Accordion.Item eventKey="0">
  <Accordion.Header>Accordion Item #1</Accordion.Header>
    <Accordion.Body> <strong>This is the first item's accordion body.</strong> It is shown by
     default, until the collapse plugin adds the appropriate classes that we
...
export const accordian7 = `<Accordion defaultActiveKey="0" 
...
export const accordian8 = `<Accordion defaultActiveKey="0" className="accordion customized-accordion accordions-items-seperate">
...
export const accordian9 = `<Accordion defaultActiveKey="0" className="accordion accordion-border-primary accordions-items-seperate">
<Accordion.Item eventKey="0">
  <Accordion.Header>Accordion Item #1</Accordion.Header>
    <Accordion.Body> <strong>This is the first item's accordion body.</strong> It is shown by
     default, until the collapse plugin adds the appropriate classes that we
...
export const accordian10 = `<Accordion defaultActiveKey="0" className="accordion accordion-border-success accordions-items-seperate">
<Accordion.Item eventKey="0">
  <Accordion.Header>Accordion Item #1</Accordion.Header>
    <Accordion.Body> <strong>This is the first item's accordion body.</strong> It is shown by
     default, until the collapse plugin adds the appropriate classes that we
...
export const accordian11 = `<Accordion defaultActiveKey="0" className="accordion accordionicon-left accordions-items-seperate">
<Accordion.Item eventKey="0">
  <Accordion.Header>Accordion Item #1</Accordion.Header>
    <Accordion.Body> <strong>This is the first item's accordion body.</strong> It is shown by
     default, until the collapse plugin adds the appropriate classes that we
...
export const accordian12 = `<Accordion defaultActiveKey="0" 
...
export const accordian13 = `<p className="mb-0">
...
export const accordian14 = `  <p className="mb-0">
...
export const accordian15 = ` <p><Button onClick={() => setOpen(!open)} aria-controls="example-collapse-text" aria-expanded={open}>
...
<Carousel.Item>
    <img src="../../../assets/images/media/media-27.jpg"
     className="d-block w-100" alt="..." />
</Carousel.Item>
<Carousel.Item>
    <img src="../../../assets/images/media/media-33.jpg" 
    className="d-block w-100" alt="..." />
</Carousel.Item>
</Carousel>`;
...
<Carousel.Item className="carousel-item active">
    <img src="../../../assets/images/media/media-63.jpg" 
    className="d-block w-100" alt="..." />
</Carousel.Item>
<Carousel.Item>
...
<Carousel.Item>
    <img src="../../../assets/images/media/media-62.jpg" 
    className="d-block w-100" alt="..." />
</Carousel.Item>
</Carousel>`;
...
<img src="../../../assets/images/media/media-14.jpg"
className="d-block w-100"
alt="..." />
<Carousel.Caption className="d-none d-md-block">
<h5 className='text-fixed-white'>Second slide label</h5>
...
export const modal8 = `export default function BasicModal () {   
            ...
            return(
                ...
                <Modal id="m1" className="fade" aria-hidden="true"
                    ...
                    <Modal.Footer>
                        <Button variant='' className="btn btn-outline-primary" onClick={Handleclose1}
...
export const offcanvas2 = `export function Defaultlink() {
                  ...
                  <Button variant='primary' className="mb-1" type="button" onClick={handleShow}
...
export const placeholder = `<p className="placeholder-glow mb-0">
                        <span className="placeholder col-12"></span>
                         </p>
                        <p className="placeholder-wave mb-0">
                        <span className="placeholder col-12"></span>
                         </p>`;
export const placeholder1 = `<span className="placeholder col-12 placeholder-xl mb-1"></span>
                         <span className="placeholder col-12 placeholder-lg"></span>
                         <span className="placeholder col-12"></span>
                         <span className="placeholder col-12 placeholder-sm"></span>
                         <span className="placeholder col-12 placeholder-xs"></span>`;
export const placeholder2 = `<span className="placeholder col-12"></span>
...
export const placeholder3 = `<span className="placeholder bg-primary col-6"></span>
