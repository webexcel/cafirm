//Typography
export const typo1 = `<h1 className="mb-3">h1. Bootstrap heading</h1>
...
export const typo2 = `<p className="h1 mb-3">h1. Bootstrap heading</p>
...
export const typo3 = `<h1 className="display-1">Display 1</h1>
<h1 className="display-2">Display 2</h1>
<h1 className="display-3">Display 3</h1>
<h1 className="display-4">Display 4</h1>
<h1 className="display-5">Display 5</h1>
<h1 className="display-6">Display 6</h1>`;
export const typo4 = `<h3>
Fancy display heading
<small className="text-muted">With faded secondary text</small>
 </h3>`;
export const typo5 = `<p>You can use the mark tag to <mark>highlight</mark> text.</p>
...
export const typo6 = `<p className="fs-1 mb-2">.fs-1 text</p>
...
export const typo7 = `<p className="lead mb-0">
...
export const typo8 = ` <dl className="row mb-0">
...
export const typo9 = `<ul className="list-unstyled">
...
export const typo10 = ` <figure className="blockquote-container">
...
export const typo11 = ` <figure className="blockquote-container text-end">
<blockquote className="blockquote mb-2">
    <h6>The greatest glory in living lies not in never falling, but in rising every time we fall.</h6>
</blockquote>
<figcaption className="blockquote-footer mt-0 mb-0 text-muted op-7"><cite title="Source Title">Nelson Mandela</cite>
</figcaption></figure>`;
export const typo12 = `<blockquote className="blockquote custom-blockquote primary mb-0 text-center">
...
export const typo13 = `<blockquote className="blockquote custom-blockquote secondary mb-0 text-center">
<h6>The future belongs to those who believe in the beauty of their dreams..</h6>
<footer className="blockquote-footer mt-3 fs-14 text-muted op-7 mb-0">Someone famous as <cite title="Source Title">-Eleanor Roosevelt</cite></footer>
<span className="quote-icon"><i className="ri-information-line"></i></span>
</blockquote>`;
export const typo14 = ` <blockquote className="blockquote custom-blockquote warning mb-0 text-center">
<h6>The future belongs to those who believe in the beauty of their dreams..</h6>
<footer className="blockquote-footer mt-3 fs-14 text-muted op-7 mb-0">Someone famous as <cite title="Source Title">-Eleanor Roosevelt</cite></footer>
<span className="quote-icon"><i className="ri-information-line"></i></span>
 </blockquote>`;
export const typo15 = `<blockquote className="blockquote custom-blockquote success mb-0 text-center">
 <h6>The future belongs to those who believe in the beauty of their dreams..</h6>
 <footer className="blockquote-footer mt-3 fs-14 text-muted op-7 mb-0">Someone famous as <cite title="Source Title">-Eleanor Roosevelt</cite></footer>
 <span className="quote-icon"><i className="ri-information-line"></i></span>
 </blockquote>`;
export const typo16 = `<blockquote className="blockquote custom-blockquote info mb-0 text-center">
 <h6>The future belongs to those who believe in the beauty of their dreams..</h6>
 <footer className="blockquote-footer mt-3 fs-14 text-muted op-7 mb-0">Someone famous as <cite title="Source Title">-Eleanor Roosevelt</cite></footer>
 <span className="quote-icon"><i className="ri-information-line"></i></span>
 </blockquote>`;
export const typo17 = ` <blockquote className="blockquote custom-blockquote danger mb-0 text-center">
 <h6>The future belongs to those who believe in the beauty of their dreams..</h6>
 <footer className="blockquote-footer mt-3 fs-14 text-muted op-7 mb-0">Someone famous as <cite title="Source Title">-Eleanor Roosevelt</cite></footer>
 <span className="quote-icon"><i className="ri-information-line"></i></span>
 </blockquote>`;
export const typo18 = `<p><abbr title="attribute">attr</abbr></p>
 <p className="mb-0"><abbr title="HyperText Markup Language" className="initialism">HTML</abbr></p>`;
export const typo19 = `<ul className="list-inline mb-0">
...
export const typo20 = `<p className="mb-1">Lorem ipsum dolor sit amet consectetur adipisicing elit. 
...
export const typo21 = "<p className=\"font-monospace mb-0\">This is in monospace</p>";
export const typo22 = ` <p className="text-muted mb-0">
 Muted text with a <a href="#" className="text-reset text-decoration-underline text-dark">reset link</a>.
 </p>`;
export const typo23 = "<p className=\"visible mb-0\">This is visible text</p>";
export const typo24 = "<p className=\"invisible mb-0\">This is invisible text</p>";
export const typo25 = `<p className="text-lowercase">Lowercased text.</p>
 <p className="text-uppercase">Uppercased text.</p>
 <p className="text-capitalize mb-0">CapiTaliZed text.</p>`;
export const typo26 = `<p className="text-decoration-underline">This text has a line underneath it.
 </p>
...
export const typo27 = `<p className="fw-bold">Bold text.</p>
...
export const typo28 = `<p className="lh-1">This is a long paragraph written to show how the line-height of
 an
...
export const typo29 = `<p className="text-start">Start aligned text on all viewport sizes.</p>
 ...
 <p className="text-xl-start">Start aligned text on viewports sized XL (extra-large)
     or
     wider.</p>`;
export const typo30 = `<div className="badge bg-primary text-wrap mb-3" style={{width: "6rem"}}>
...
export const typo31 = ` <p className="text-break mb-0">
...
export const alert1 = `{Linkalerts.map((idx)=>(
...
export const alert6 = `{roundedsolidalert.map((idx,alt7)=>(
...
export const alert7 = ` {roundedoutlinealert.map((idx) => (
...
export const alert8 = `<Alert variant='solid-primary' className="alert shadow alert-dismissible fade show">
...
export const alert9 = `<Alert variant='primary' className="alert shadow">A simple primary alert with normal shadow—check it out!</Alert>
...
export const alert17 = `{Defaultalerts.map((idx)=>(
...
export const braed1 = `<nav aria-label="breadcrumb">
                <Breadcrumb>
...
export const bread2 = `<nav aria-label="breadcrumb">
...
export const bread5 = `<nav aria-label="breadcrumb">
...
export const bread6 = `<nav aria-label="breadcrumb">
...
export const group11 = `<ButtonGroup className="btn-group" role="group" aria-label="Basic example"> 
...
export const list1 = `{BasicButtons.map((idx)=>(
...
export const list3 = `<ListGroup as="ul">
...
export const list4 = ` <ListGroup variant='flush' className="">
...
export const list6 = `<ListGroup className="list-group">
...
export const list10 = ` <ListGroup as="ul">
...
export const list11 = ` <ListGroup as="ol" numbered>
...
export const list12 = `<ListGroup as="ol" numbered>
<ListGroup.Item as="li">Simply dummy text of the printing.</ListGroup.Item>
<ListGroup.Item as="li">There are many variations of passages.</ListGroup.Item>
<ListGroup.Item as="li">All the Lorem Ipsum generators.</ListGroup.Item>
<ListGroup.Item as="li">Written in 45 BC. This book is a treatise on the theory.</ListGroup.Item>
...
export const list13 = ` <ListGroup as="ul">
...
export const list14 = `  <ListGroup className="list-group">
...
export const list15 = `	{ListbadgesButtons.map((idx) => (
...
export const list16 = `<ListGroup as="ul" className="list-group list-group-horizontal-md">
...
export const page2 = ` <Pagination className="pagination mb-0">
...
export const page3 = ` 	<nav aria-label="...">
...
export const page4 = `<nav aria-label="Page navigation">
...
export const page5 = `<nav aria-label="..." className="me-3">
...
export const page6 = `<nav aria-label="Page navigation" className="pagination-style-1">
...
export const page7 = `<nav aria-label="Page navigation" className="pagination-style-1">
      <Pagination className="pagination mb-0">
      <Pagination.Item disabled href="#">
      <i className="ri-arrow-left-s-line align-middle"></i>       
      </Pagination.Item>
...
export const page8 = `<nav aria-label="Page navigation" className="pagination-style-3">
...
export const page9 = `<nav aria-label="Page navigation"className="pagination-style-4">
      <Pagination className="mb-0 flex-wrap">
...
//Popovers
export const pop1 = `{Defaultalerts.map((idx)=>(
...
export const pop2 = `<OverlayTrigger trigger="click" placement={idx.class}  key={Math.random()}
        overlay={<Popover>
...
export const pop6 = ` <OverlayTrigger placement='right' overlay={<Popover id="tooltip-disabled">
...
export const pop7 = `<OverlayTrigger placement='top' trigger="click" overlay={<Popover className='popover-primary only-body' id="tooltip-disabled">
...
export const pop9 = `  <OverlayTrigger placement='top' trigger="click" overlay={<Popover className='popover-secondary only-body' id="tooltip-disabled">
       <Popover.Body>This popover is used to provide details about this icon.</Popover.Body>
        </Popover>}>
...
export const progress5 = `<ProgressBar  variant='' className="progress mb-3" animated now={10} />
...
export const toast4 = `  <ToastContainer className="toast-container position-fixed top-0 end-0 p-3">
...
export const toast6 = ` <Toast className="toast align-items-center text-bg-primary border-0 fade show mb-4"  show={showC}>
...
export const toast7 = `<Toast show={showA} onClose={toggleShowA} className="toast show"
...
export const toast8 = ` <ToastContainer className="toast-container position-static">
...
export const toast9 = `<Toast show={showA} onClose={toggleShowA} className="toast show"
                                     role="alert" aria-live="assertive" aria-atomic="true" data-bs-autohide="false">
                                      <Toast.Header>
                                                 <img src={favi} alt="" className="me-2" height="18" />
                                      <strong className="me-auto">Velvet</strong>
...
export const taost10 = `<Toast role="alert" 
...
export const toast11 = ` <div className="bd-example bg-light bd-example-toasts d-flex p-0 px-3">
...
export const tool4 = `<OverlayTrigger placement="top" overlay={
...
export const accordian2 = ` <Accordion defaultActiveKey="0" flush>
