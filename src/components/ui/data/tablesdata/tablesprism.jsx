...
export const tabel12 = ` <Table className="text-nowrap table-bordered border-success">
<thead>
    <tr>
        <th scope="col">Order</th>
        <th scope="col">Date</th>
...
export const tabel16 = `  <Table className="table text-nowrap">
...
export const tabel18 = `<Table className="table text-nowrap">
...
export const tabel19 = `<Table className="table text-nowrap">
...
export const tabel23 = `  <Table className="text-nowrap table-striped table-hover">
<thead>
    <tr>
