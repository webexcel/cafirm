...
const CreateTicketModel = React.memo(({ show, handleClose, employeeData, Option2, handleTicketSubmit, validationSchema }) => {
    return (
        <Modal show={show} onHide={handleClose} className="fade" id="addticket" tabIndex={-1} aria-hidden="true">
            <Formik
                initialValues={{
                    ticketName: "",
                    service: "",
                ...
                {({ values, setFieldValue }) => (
                    <FormikForm>
                        <Modal.Header closeButton>
                            <h6 className="modal-title" id="mail-ComposeLabel">Create Ticket</h6>
                        </Modal.Header>
                        <Modal.Body className="px-4">
                            <div className="row gy-2">
                                ...
                                <Col xl={12}>
                                    ...
                                    <Field type="text" name="ticketName" className="form-control" placeholder="Ticket Name" />
                                    <ErrorMessage name="ticketName" component="div" className="text-danger" />
                                </Col>
